...
@group(0) @binding(1) var<storage, read> tile64_zmin: array<u32>;
@group(0) @binding(2) var<storage, read> tile16_zmin: array<u32>;
@group(0) @binding(3) var<storage, read> tile4_zmin: array<u32>;
@group(0) @binding(4) var<storage, read> result: array<u32>;
@group(0) @binding(5) var<storage, read_write> merged: array<u32>;
