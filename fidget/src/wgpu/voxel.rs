use crate::{
    ...
    render::{
        ImageSize, RenderHandle, RenderWorker, Tile as RenderTile, TileSizes,
        VoxelRenderConfig,
    },
    shape::{Shape, ShapeTracingEval, ShapeVars},
    types::Interval,
    wgpu::{voxel_tiles_shader, Config, Tile, TileContext},
    Error,
};
...
impl VoxelContext {
    ...
    pub fn run_3d<F: Function + MathFunction>(
        ...
        self.ctx.resize_out_buf(settings.image_size.into());
        self.resize_result_buf(settings.image_size.into());
